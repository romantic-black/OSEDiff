...
from dataloaders.realsr_dataset import PairedSROnlineTxtDataset, WaymoRepairDataset
...
def parse_args(input_args=None):
   ...
   """
    ...
    # training details
    parser.add_argument("--output_dir", default='experience/waymo')
    ...
    parser.add_argument("--tracker_project_name", type=str, default="train_waymo", help="The name of the wandb project to log to.")
    ...
    # ram path
    parser.add_argument('--ram_path', type=str, default="/mnt/e/download/ram_swin_large_14m.pth", help='Path to RAM model')
...
def main(args):
    ...
    dataset_train = WaymoRepairDataset(split="train", args=args)
